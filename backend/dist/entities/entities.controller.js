...
const entity_dto_1 = require("./dto/entity.dto");
...
let EntitiesController = class EntitiesController {
    ...
    async reorder(user, projectId, body) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, entity_dto_1.CreateEntityDto]),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], EntitiesController.prototype, "reorder", null);
__decorate([
    (0, common_1.Get)(':id'),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
...
__decorate([
    ...
    __param(2, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String, entity_dto_1.UpdateEntityDto]),
    __metadata("design:returntype", Promise)
